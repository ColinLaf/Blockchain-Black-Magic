...
class Blockchain():
    ...
    def add_transaction(self, t_num, loc, time):
        ...
        self.transactions.append(t_num)  ## ID
        self.transactions.append(loc)    ## location
        self.transactions.append(time)   ## time card swiped
